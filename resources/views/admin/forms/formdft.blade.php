...
<head>
    ...
    <title>Attendance Mail | <?php echo strtoupper($_SESSION['role']) ?></title>
</head>
...
<div class="sidenav">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <div class="dropdown-container">
                        ...
                        <a href="/create?type=<?php echo md5("dft") ?>" class="ml-5 active">
    ...
    <div class="main">
        ...
        Attendance Mail / <?php echo strtoupper($_SESSION['role'])." ".$_SESSION['id'] ?></p>
        <form class="form ml-2 mr-2" style="font-family:michroma" method="POST" action="insert">
            @csrf
            <input type="hidden" class="form-control" name="dbs" id="dbs" value="dft_hadir">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nm_e" id="nm_e" placeholder="Event Name">
            </div>
            <div class="form-group">
                <label for="date">Date</label>
                <input type="date" class="form-control" style="width:180px" name="tgl" id="tgl">
            </div>
            <div class="form-group">
                <label for="date">Time</label>
                <div class="form-inline">
                <label for="time">Start</label>
                <input type="text" class="form-control ml-2 mr-2" style="width:150px" name="stime" id="stime" placeholder="Start">
                <label for="time">until</label>
                <input type="text" class="form-control ml-2 mr-2" style="width:150px" name="etime" id="etime" placeholder="End">
                <label for="time">WIB</label>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="ev-man">Event Manager</label>
                <input type="text" class="form-control" name="evman" id="evman" placeholder="Event Manager Name">
            </div>
