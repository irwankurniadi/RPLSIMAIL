            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <div class="dropdown-container">
                        ...
                        <a href="/create?type=<?php echo md5("sk") ?>" class="ml-5 active">
    ...
    <div class="main">
        ...
        <form class="form ml-2 mr-2" style="font-family:michroma" method="POST" action="insert">
            ...
            <div class="form-group" id="applicant">
                ...
                <input type="text" class="form-control mb-1" name="sem" id="sem" placeholder="Semester">
            </div>
            <div class="form-group">
                <label for="date">Major</label>
                <input type="text" class="form-control" name="maj" id="maj" placeholder="Student's Major">
            </div>
            <div class="form-group">
                <label for="date">Faculty</label>
                <input type="text" class="form-control" name="fac" id="fac" placeholder="Student's Faculty">
            </div>
