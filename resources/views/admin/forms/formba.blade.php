...
<head>
    ...
    <title>News Mail | <?php echo strtoupper($_SESSION['role']) ?></title>
</head>
...
<div class="sidenav">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <div class="dropdown-container">
                        ...
                        <a href="/create?type=<?php echo md5("ba") ?>" class="ml-5 active">
    ...
    <div class="main">
        ...
        News Mail / <?php echo strtoupper($_SESSION['role'])." ".$_SESSION['id'] ?></p>
        <form class="form ml-2 mr-2" style="font-family:michroma" method="POST" action="insert">
            @csrf
            <input type="hidden" name="dbs" id="dbs" value="b_acara">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control mt-2" name="tm_e" id="tm_e" placeholder="Event Theme">
            </div>
            <div class="form-group">
