...
<head>
    ...
    <title>Assignment Mail | <?php echo strtoupper($_SESSION['role']) ?></title>
</head>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <div class="dropdown-container">
                        ...
                        <a href="/create?type=<?php echo md5("st") ?>" class="ml-5 active">
    ...
    <div class="main">
        ...
        <form class="form ml-2 mr-2" style="font-family:michroma" method="POST" action="/insert">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control ml-2 mr-2" name="tgls" id="tgls">
                <label for="date">End Date</label>
                <input type="date" class="form-control ml-2 mr-2" name="tgle" id="tgle">
                </div>
            </div>
            <div class="form-group">
                <label for="event">Event</label>
                <input type="text" class="form-control" name="ev" id="ev" placeholder="Event Name">
            </div>
            <div class="form-group">
