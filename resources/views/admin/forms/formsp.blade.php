...
<head>
    ...
    <title>Personal Mail | <?php echo strtoupper($_SESSION['role']) ?></title>
</head>
...
<body>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <div class="dropdown-container">
                        <a href="/create?type=<?php echo md5("sp") ?>" class="ml-5 active">
    ...
    <div class="main">
        ...
        Personal Mail / <?php echo strtoupper($_SESSION['role'])." ".$_SESSION['id'] ?></p>
        <form class="form ml-2 mr-2" style="font-family:michroma" method="POST" action="/insert">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="pp" id="pp" placeholder="Purpose of the Letter">
            </div>
            <div class="form-group mt-2">
                <label for="date">Date</label>
                <input type="date" style="width:180px" class="form-control" name="tgl" id="tgl">
            </div>
            <div class="form-group">
                <label for="date">Addressed to</label>
                <input type="text" class="form-control" name="at" id="at" placeholder="Recipient's Name">
            </div>
            <div class="form-group">
                <label for="date">Location</label>
                <input type="text" class="form-control" name="lok" id="lok" placeholder="Recipient Address">
            </div>
            <div class="form-group">
                <label for="date">Description</label><br>
                <textarea class="input" name="desc" rows="5" cols="128" wrap="soft" style="overflow:hidden; resize:none; border-radius:5px" placeholder="  Letter Description"></textarea>
            </div>
